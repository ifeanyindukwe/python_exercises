...
class CallTypeVisualizer:
    ...
    def plot_call_type_distribution(self):
        """Create and save a bar graph for the number of occurrences of each call type."""
        if self.call_type_counts is not None:
            ...
            # Create a 'visualization' folder if it doesn't exist
            os.makedirs('visualization', exist_ok=True)
            
            # Define the file name
            file_name = 'visualization/call_type_distribution.png'
